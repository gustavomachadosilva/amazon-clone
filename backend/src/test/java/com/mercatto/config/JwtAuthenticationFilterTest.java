...
class JwtAuthenticationFilterTest {
    ...
    @Test
    void publicPath_reviewsByProduct_withoutHeader_callsChain() throws ServletException, IOException {
        MockHttpServletRequest request = new MockHttpServletRequest("GET", "/api/reviews/products/1");
        MockHttpServletResponse response = new MockHttpServletResponse();
        MockFilterChain chain = new MockFilterChain();
    ...
    @Test
    void protectedPath_reviewsHelpful_withoutHeader_returns401AndDoesNotCallChain() throws ServletException, IOException {
        MockHttpServletRequest request = new MockHttpServletRequest("POST", "/api/reviews/1/helpful");
        MockHttpServletResponse response = new MockHttpServletResponse();
        MockFilterChain chain = new MockFilterChain();
