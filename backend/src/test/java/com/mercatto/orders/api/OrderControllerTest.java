...
class OrderControllerTest {
    ...
    void checkoutWithValidRequest_returns200() throws Exception {
        ...
        OrderController.CheckoutRequest request = new OrderController.CheckoutRequest(
                10L, List.of(new OrderService.CheckoutItem(1L, 2)));
    ...
    static Stream<OrderController.CheckoutRequest> invalidRequests() {
        return Stream.of(
                // buyerId null
                new OrderController.CheckoutRequest(null, List.of(new OrderService.CheckoutItem(1L, 2))),
                // items empty
                new OrderController.CheckoutRequest(10L, List.of()),
                // item quantity <= 0
                new OrderController.CheckoutRequest(10L, List.of(new OrderService.CheckoutItem(1L, 0))),
                // item productId null
                new OrderController.CheckoutRequest(10L, List.of(new OrderService.CheckoutItem(null, 2)))
        );
    }
